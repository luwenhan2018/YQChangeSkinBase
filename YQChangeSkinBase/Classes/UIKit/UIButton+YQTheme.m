...
@implementation UIButton (YQTheme)
              ...
              forState:(UIControlState)state
{
    ...
    [self setImage:[YQThemeManager imageWithName:imageName] forState:state];
}
                        ...
                        forState:(UIControlState)state
{
    ...
    [self theme_registChangedNotification];
    [self setBackgroundImage:[YQThemeManager imageWithName:imageName] forState:state];
}
                   ...
                   forState:(UIControlState)state
{
    ...
    [self theme_registChangedNotification];
    [self setTitleColor:[YQThemeManager colorWithID:color] forState:state];
}

- (void)theme_setBackgroundColor:(NSString *)color
                        forState:(UIControlState)state
{
    UIImage *image = [UIImage yq_imageWithColor:[YQThemeManager colorWithID:color]];
...
- (void)theme_didChanged {
    ...
    [self.theme_images enumerateKeysAndObjectsUsingBlock:^(NSNumber *key, NSString *obj, BOOL * _Nonnull stop) {
        [self setImage:[YQThemeManager imageWithName:obj]
    ...
    [self.theme_backgroundImages enumerateKeysAndObjectsUsingBlock:^(NSNumber *key, NSString *obj, BOOL * _Nonnull stop) {
        [self setBackgroundImage:[YQThemeManager imageWithName:obj] forState:key.unsignedIntegerValue];
    }];
    [self.theme_titleColors enumerateKeysAndObjectsUsingBlock:^(NSNumber *key, NSString *obj, BOOL * _Nonnull stop) {
        [self setTitleColor:[YQThemeManager colorWithID:obj] forState:key.unsignedIntegerValue];
    }];
    [self.theme_backgroundColors enumerateKeysAndObjectsUsingBlock:^(NSNumber *key, NSString *obj, BOOL * _Nonnull stop) {
        UIImage *image = [UIImage yq_imageWithColor:[YQThemeManager colorWithID:obj]];
